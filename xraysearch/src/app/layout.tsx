...
export const metadata: Metadata = {
  title: "XRaySearch — Intelligent Chest X-Ray Retrieval",
  description: "Semantic search for chest X-rays powered by Google CXR Vision Transformer and HNSW indexing.",
};
